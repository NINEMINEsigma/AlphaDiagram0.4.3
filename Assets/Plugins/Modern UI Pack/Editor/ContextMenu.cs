...
namespace Michsky.UI.ModernUIPack
{
    public class ContextMenu : Editor
    {
        static void CreateObject(string resourcePath)
        {
            ...
            {
                if (EditorUtility.DisplayDialog("Modern UI Pack", "Cannot create the object due to missing/incorrect root parent. " +
                    "You can change the root parent by clicking 'Fix' button and enabling 'Change Root Folder'.", "Fix", "Cancel"))
                    ShowManager();
            }
        ...
        static void ShowManager()
        {
            ...
            if (Selection.activeObject == null)
                Debug.Log("<b>[Modern UI Pack]</b>Can't find a file named 'MUIP Manager'. Make sure you have 'MUIP Manager' file in Resources parent.");
        }
